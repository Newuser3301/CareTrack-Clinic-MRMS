...
const itemClass = ({ isActive }) =>
  `inline-flex h-14 w-14 items-center justify-center rounded-2xl border shadow-sm transition ${
    isActive
  ...
  return (
    <nav className="lg:hidden">
      <div className="px-4 pb-3">
        <div className="mx-auto w-full max-w-md rounded-[1.75rem] border border-white/70 bg-white/55 p-2 shadow-panel backdrop-blur">
