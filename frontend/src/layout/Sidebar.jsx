...
const Sidebar = ({ open, onClose }) => {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-3 left-3 z-40 w-64 transform rounded-[1.75rem] bg-gradient-to-b from-primary-700 via-cyan-950 to-slate-950 text-white shadow-soft transition lg:fixed lg:left-6 lg:top-0 lg:h-screen lg:w-40 lg:translate-x-0 lg:overflow-y-auto ${
